...
function componentChange(){
  ...
  TweenMax.to(path2666, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to(path2154, .5, {rotation:40, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to(path1818, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to(path2662, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to([lfbH2,lfbH1,lfbPilot,lrbH2,lrbH1,lrbPilot,rfbH2,rfbH1,rfbPilot,rrbH2,rrbH1,rrbPilot], .5, {rotation:0, transformOrigin: "0% 0%", ease: Power0.easeNone});
  ...
  switch(componentSelect.value) {
    ...
    case "bakeElement":
    TweenMax.to(path2666, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
    TweenMax.to(path2154, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
    TweenMax.to(path1818, .5, {rotation:64, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;

    case "ovenLamp":
    TweenMax.to(path2662, .5, {rotation:28, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;

    case "burnerLF":
    TweenMax.to([lfbH2,lfbH1,lfbPilot], .5, {rotation:-20, transformOrigin: "0% 0%", ease: Power0.easeNone});
    break;
    case "burnerLR":
    TweenMax.to([lrbH2,lrbH1,lrbPilot], .5, {rotation:-20, transformOrigin: "0% 0%", ease: Power0.easeNone});
    break;
    case "burnerRF":
    TweenMax.to([rfbH2,rfbH1,rfbPilot], .5, {rotation:-20, transformOrigin: "0% 0%", ease: Power0.easeNone});
    break;
    case "burnerRR":
    TweenMax.to([rrbH2,rrbH1,rrbPilot], .5, {rotation:-20, transformOrigin: "0% 0%", ease: Power0.easeNone});
    break;
    }
