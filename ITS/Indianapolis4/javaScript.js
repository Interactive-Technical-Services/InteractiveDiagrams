...
function componentChange(){
  TweenMax.to(path9202, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  ...
  switch(componentSelect.value) {
    case "hvTransformer":
    TweenMax.to(path9202, .5, {rotation:-20, transformOrigin: "0% 100%", ease: Power0.easeNone});
