...
function componentChange(){
  ...
  switch(componentSelect.value) {
    case "defrostHeater":
      TweenMax.to(g318, .5, {rotation:-30, transformOrigin: "0% 40%", ease: Power0.easeNone});
    break;
    case "freshFoodLight":
    scaleUp = scaleUp + .1;
      TweenMax.to(g9462, .5, {rotation:-30, transformOrigin: "0% 40%", ease: Power0.easeNone});
        break;
    }
}
...
function clearHighlights(){
  TweenMax.to(g318, .5, {rotation:0, transformOrigin: "0% 40%", ease: Power0.easeNone});
  TweenMax.to(g9462, .5, {rotation:0, transformOrigin: "0% 40%", ease: Power0.easeNone});
