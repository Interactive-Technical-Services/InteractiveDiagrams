document.title = "Free Standing Range - Calrod"
...
function componentChange(){
 ...
 TweenMax.to(path2688, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to(path3648, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to(path3616, .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to([path2676,path2676copy], .5, {rotation:30, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to([path9933,path9933copy], .5, {rotation:30, transformOrigin: "0% 100%", ease: Power0.easeNone});
  TweenMax.to([path2700,path2700copy], .5, {rotation:30, transformOrigin: "0% 100%", ease: Power0.easeNone});

  switch(componentSelect.value) {
    case "defrostFuseOpen":
    TweenMax.to(path2688, .5, {rotation:-30, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;
    ...
    case "defrostThermostat1Open":
    TweenMax.to(path2688, .5, {rotation:-30, transformOrigin: "0% 100%", ease: Power0.easeNone});
    TweenMax.to(path3648, .5, {rotation:40, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;

    case "defrostThermostat2Open":
    TweenMax.to(path2688, .5, {rotation:-30, transformOrigin: "0% 100%", ease: Power0.easeNone});
    TweenMax.to(path3616, .5, {rotation:40, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;
    
    case "fFLightOn":
    TweenMax.to([path2676,path2676copy], .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;
    ...
    case "waterValve":
    TweenMax.to([path9933,path9933copy], .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;

    case "tempControlSatisfied":
    TweenMax.to([path2700,path2700copy], .5, {rotation:30, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;

    case "tempControlNotSatisfied":
    TweenMax.to([path2700,path2700copy], .5, {rotation:0, transformOrigin: "0% 100%", ease: Power0.easeNone});
    break;
    }
